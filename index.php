  ...
  <head>
    ...
    <script>
      ...
      function myCallback(url, answer) {
        //  alert(url + ': ' + answer);
        if(answer) {
          document.getElementById("searchbar").innerHTML = '<button class="btn btn-large btn-primary" type="button" onclick="getImages();return false;">Random Imgur Image</button>';
          document.getElementById('textID').value = imgObject.src;
          document.getElementById("imgID").src = imgObject.src;
          document.getElementById("resID").innerHTML = '<a href="'+imgObject.src+'" id="hrefID" title="Click for full size">'+imgObject.width+'x'+imgObject.height+'</a>';
          document.getElementById("infoID").innerHTML = '<a href="#imageInfo" data-toggle="modal">Info</a>';
          document.getElementById("infoRes").innerHTML = imgObject.width+'x'+imgObject.height;
          var id= imgObject.src.substring(19,24);
          document.getElementById('imgurLink').innerHTML = '<a href="http://imgur.com/a/' + id + '">http://imgur.com/a/' + id + '</a>';
        } else {
    ...
    <div id="wrap">
      <div class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li><a href="puush.php">Play Puush Roulette</a></li>
        ...
        <div class="container search-field" id="searchbar" style="text-align:center;height:65px;">
            ...
            <button class="btn btn-large btn-primary" type="button" onclick="getImages();return false;">Random Imgur Image</button>
...
<div id="siteInfo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="SiteInfo" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <li>All content is hosted by <a href="http://www.imgur.com">Imgur</a></li></ul>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
  </div>
